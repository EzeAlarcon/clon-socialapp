...
const Actions = ({ post }) => {
  ...
  const handleLikeAndUnlike = async () => {
    ...
    try {
      ...
      if (!liked) {
        // agregue la identificación del usuario actual a la matriz post.likes
        ...
        // eliminar la identificación del usuario actual de la matriz post.likes
        const updatedPosts = posts.map((p) => {
          if (p._id === post._id) {
